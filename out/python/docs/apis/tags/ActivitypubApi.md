<a name="__pageTop"></a>
# openapi_client.apis.tags.activitypub_api.ActivitypubApi

All URIs are relative to */api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**activitypub_person**](#activitypub_person) | **get** /activitypub/user/{username} | Returns the Person actor for a user
[**activitypub_person_inbox**](#activitypub_person_inbox) | **post** /activitypub/user/{username}/inbox | Send to the inbox

# **activitypub_person**
<a name="activitypub_person"></a>
...
<a name="activitypub_person_inbox"></a>
