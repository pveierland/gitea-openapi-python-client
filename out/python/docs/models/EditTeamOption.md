# openapi_client.model.edit_team_option.EditTeamOption
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | EditTeamOption options for editing a team | 
...
**permission** | str,  | str,  |  | [optional] must be one of ["read", "write", "admin", ] 
