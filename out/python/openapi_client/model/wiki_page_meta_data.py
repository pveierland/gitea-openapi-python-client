...
class WikiPageMetaData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["html_url", "last_commit", "sub_url", "title", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["html_url", "last_commit", "sub_url", "title", ], str]):
