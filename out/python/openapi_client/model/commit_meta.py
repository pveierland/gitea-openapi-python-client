...
class CommitMeta(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created", "sha", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created", "sha", "url", ], str]):
