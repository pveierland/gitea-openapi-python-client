...
class EditReleaseOption(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["body", "draft", "name", "prerelease", "tag_name", "target_commitish", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["body", "draft", "name", "prerelease", "tag_name", "target_commitish", ], str]):
