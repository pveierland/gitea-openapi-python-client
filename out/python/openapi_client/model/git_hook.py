...
class GitHook(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["content", "is_active", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["content", "is_active", "name", ], str]):
