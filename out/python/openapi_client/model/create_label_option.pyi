...
class CreateLabelOption(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["color", "name", "description", "exclusive", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["color", "name", "description", "exclusive", ], str]):
