...
class CreateOrgOption(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["username", "description", "full_name", "location", "repo_admin_change_team_access", "visibility", "website", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["username", "description", "full_name", "location", "repo_admin_change_team_access", "visibility", "website", ], str]):
