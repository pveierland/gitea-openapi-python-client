...
class GitBlobResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["content", "encoding", "sha", "size", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["content", "encoding", "sha", "size", "url", ], str]):
