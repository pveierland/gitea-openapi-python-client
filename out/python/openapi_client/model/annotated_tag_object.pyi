...
class AnnotatedTagObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sha", "type", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sha", "type", "url", ], str]):
