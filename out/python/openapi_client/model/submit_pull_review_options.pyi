...
class SubmitPullReviewOptions(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["body", "event", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["body", "event", ], str]):
