...
class CreateForkOption(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "organization", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "organization", ], str]):
