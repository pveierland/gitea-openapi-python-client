...
class FileLinksResponse(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["git"]) -> MetaOapg.properties.git: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["git", "html", "self", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["git"]) -> typing.Union[MetaOapg.properties.git, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["git", "html", "self", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        git: typing.Union[MetaOapg.properties.git, str, schemas.Unset] = schemas.unset,
