...
Note: `author` and `committer` are optional (if only one is given, it will be used for the other, otherwise the authenticated user will be used)
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["from_path"]) -> MetaOapg.properties.from_path: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["content", "sha", "author", "branch", "committer", "dates", "from_path", "message", "new_branch", "signoff", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["from_path"]) -> typing.Union[MetaOapg.properties.from_path, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["content", "sha", "author", "branch", "committer", "dates", "from_path", "message", "new_branch", "signoff", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        from_path: typing.Union[MetaOapg.properties.from_path, str, schemas.Unset] = schemas.unset,
