...
# body param
SchemaForRequestBodyApplicationJson = EditDeadlineOption
...
SchemaFor201ResponseBodyApplicationJson = IssueDeadline
...
class BaseApi(api_client.Api):
    @typing.overload
    def _issue_edit_issue_deadline_oapg(
        self,
...
class IssueEditIssueDeadline(BaseApi):
    ...
    def issue_edit_issue_deadline(
        ...
        return self._issue_edit_issue_deadline_oapg(
            body=body,
