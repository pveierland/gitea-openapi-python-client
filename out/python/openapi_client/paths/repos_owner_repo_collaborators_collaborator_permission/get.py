...
SchemaFor200ResponseBodyApplicationJson = RepoCollaboratorPermission
...
class BaseApi(api_client.Api):
    @typing.overload
    def _repo_get_repo_permissions_oapg(
        self,
...
class RepoGetRepoPermissions(BaseApi):
    ...
    def repo_get_repo_permissions(
        ...
        return self._repo_get_repo_permissions_oapg(
