...
# body param
SchemaForRequestBodyApplicationJson = AddCollaboratorOption
SchemaForRequestBodyTextPlain = AddCollaboratorOption
...
class BaseApi(api_client.Api):
    @typing.overload
    def _repo_add_collaborator_oapg(
        self,
...
class RepoAddCollaborator(BaseApi):
    ...
    def repo_add_collaborator(
        ...
        return self._repo_add_collaborator_oapg(
            body=body,
