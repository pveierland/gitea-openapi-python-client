...
# body param
SchemaForRequestBodyApplicationJson = TransferRepoOption
SchemaForRequestBodyTextPlain = TransferRepoOption
...
class RepoTransfer(BaseApi):
    ...
    def repo_transfer(
        ...
        return self._repo_transfer_oapg(
            body=body,
