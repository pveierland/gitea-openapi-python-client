...
# body param
SchemaForRequestBodyApplicationJson = CreatePullRequestOption
...
class BaseApi(api_client.Api):
    @typing.overload
    def _repo_create_pull_request_oapg(
        self,
...
class RepoCreatePullRequest(BaseApi):
    ...
    def repo_create_pull_request(
        ...
        return self._repo_create_pull_request_oapg(
            body=body,
