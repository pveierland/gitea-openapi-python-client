...
request_query_style = api_client.QueryParameter(
    name="style",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _repo_update_pull_request_oapg(
        self,
...
class RepoUpdatePullRequest(BaseApi):
    ...
    def repo_update_pull_request(
        ...
        return self._repo_update_pull_request_oapg(
