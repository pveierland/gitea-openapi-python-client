...
SchemaFor205ResponseBodyApplicationJson = NotificationThread
...
class NotifyReadThread(BaseApi):
    ...
    def notify_read_thread(
        ...
        return self._notify_read_thread_oapg(
