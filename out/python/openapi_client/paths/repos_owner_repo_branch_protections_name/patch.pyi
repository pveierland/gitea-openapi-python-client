...
# body param
SchemaForRequestBodyApplicationJson = EditBranchProtectionOption
...
SchemaFor200ResponseBodyApplicationJson = BranchProtection
...
class BaseApi(api_client.Api):
    @typing.overload
    def _repo_edit_branch_protection_oapg(
        self,
...
class RepoEditBranchProtection(BaseApi):
    ...
    def repo_edit_branch_protection(
        ...
        return self._repo_edit_branch_protection_oapg(
            body=body,
