...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TimelineComment']:
            return TimelineComment

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['TimelineComment'], typing.List['TimelineComment']],
    ...
    def __getitem__(self, i: int) -> 'TimelineComment':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _issue_get_comments_and_timeline_oapg(
        self,
...
class IssueGetCommentsAndTimeline(BaseApi):
    ...
    def issue_get_comments_and_timeline(
        ...
        return self._issue_get_comments_and_timeline_oapg(
