...
SchemaFor201ResponseBodyApplicationJson = OAuth2Application
...
class BaseApi(api_client.Api):
    @typing.overload
    def _user_create_o_auth2_application_oapg(
        self,
...
class UserCreateOAuth2Application(BaseApi):
    ...
    def user_create_o_auth2_application(
        ...
        return self._user_create_o_auth2_application_oapg(
            body=body,
