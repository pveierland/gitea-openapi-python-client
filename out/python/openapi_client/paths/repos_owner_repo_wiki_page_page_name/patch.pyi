...
request_path_page_name = api_client.PathParameter(
    name="pageName",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PageNameSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = CreateWikiPageOptions
...
SchemaFor200ResponseBodyApplicationJson = WikiPage
SchemaFor200ResponseBodyTextHtml = WikiPage
...
class RepoEditWikiPage(BaseApi):
    ...
    def repo_edit_wiki_page(
        ...
        return self._repo_edit_wiki_page_oapg(
            body=body,
