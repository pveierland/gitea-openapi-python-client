...
# body param
SchemaForRequestBodyApplicationJson = EditPullRequestOption
...
SchemaFor201ResponseBodyApplicationJson = PullRequest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _repo_edit_pull_request_oapg(
        self,
...
class RepoEditPullRequest(BaseApi):
    ...
    def repo_edit_pull_request(
        ...
        return self._repo_edit_pull_request_oapg(
            body=body,
