...
# body param
SchemaForRequestBodyApplicationJson = CreateBranchProtectionOption
...
SchemaFor201ResponseBodyApplicationJson = BranchProtection
...
class BaseApi(api_client.Api):
    @typing.overload
    def _repo_create_branch_protection_oapg(
        self,
...
class RepoCreateBranchProtection(BaseApi):
    ...
    def repo_create_branch_protection(
        ...
        return self._repo_create_branch_protection_oapg(
            body=body,
