...
# body param
SchemaForRequestBodyApplicationJson = AddTimeOption
...
SchemaFor200ResponseBodyApplicationJson = TrackedTime
...
class IssueAddTime(BaseApi):
    ...
    def issue_add_time(
        ...
        return self._issue_add_time_oapg(
            body=body,
