...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Cron']:
            return Cron

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['Cron'], typing.List['Cron']],
    ...
    def __getitem__(self, i: int) -> 'Cron':
...
class AdminCronList(BaseApi):
    ...
    def admin_cron_list(
        ...
        return self._admin_cron_list_oapg(
