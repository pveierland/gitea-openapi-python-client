...
# body param
SchemaForRequestBodyApplicationJson = DismissPullReviewOptions
SchemaForRequestBodyTextPlain = DismissPullReviewOptions
...
class BaseApi(api_client.Api):
    @typing.overload
    def _repo_dismiss_pull_review_oapg(
        self,
...
class RepoDismissPullReview(BaseApi):
    ...
    def repo_dismiss_pull_review(
        ...
        return self._repo_dismiss_pull_review_oapg(
            body=body,
