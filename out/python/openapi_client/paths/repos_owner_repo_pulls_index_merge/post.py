...
# body param
SchemaForRequestBodyApplicationJson = MergePullRequestOption
SchemaForRequestBodyTextPlain = MergePullRequestOption
...
class BaseApi(api_client.Api):
    @typing.overload
    def _repo_merge_pull_request_oapg(
        self,
...
class RepoMergePullRequest(BaseApi):
    ...
    def repo_merge_pull_request(
        ...
        return self._repo_merge_pull_request_oapg(
            body=body,
