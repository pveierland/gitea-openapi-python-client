...
# body param
SchemaForRequestBodyApplicationJson = CreateLabelOption
...
SchemaFor201ResponseBodyApplicationJson = Label
...
class IssueCreateLabel(BaseApi):
    ...
    def issue_create_label(
        ...
        return self._issue_create_label_oapg(
            body=body,
