...
# body param
SchemaForRequestBodyApplicationJson = CreateKeyOption
...
SchemaFor201ResponseBodyApplicationJson = DeployKey
...
class RepoCreateKey(BaseApi):
    ...
    def repo_create_key(
        ...
        return self._repo_create_key_oapg(
            body=body,
