...
SchemaFor200ResponseBodyApplicationJson = OrganizationPermissions
...
class BaseApi(api_client.Api):
    @typing.overload
    def _org_get_user_permissions_oapg(
        self,
...
class OrgGetUserPermissions(BaseApi):
    ...
    def org_get_user_permissions(
        ...
        return self._org_get_user_permissions_oapg(
