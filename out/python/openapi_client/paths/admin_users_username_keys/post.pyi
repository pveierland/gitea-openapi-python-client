...
request_body_key = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = PublicKey
...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_create_public_key_oapg(
        self,
    ...
    def _admin_create_public_key_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_key.serialize(body, content_type)
...
class AdminCreatePublicKey(BaseApi):
    ...
    def admin_create_public_key(
        ...
        return self._admin_create_public_key_oapg(
            body=body,
