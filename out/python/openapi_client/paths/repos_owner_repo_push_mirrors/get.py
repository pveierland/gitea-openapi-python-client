...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PushMirror']:
            return PushMirror

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['PushMirror'], typing.List['PushMirror']],
    ...
    def __getitem__(self, i: int) -> 'PushMirror':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _repo_list_push_mirrors_oapg(
        self,
...
class RepoListPushMirrors(BaseApi):
    ...
    def repo_list_push_mirrors(
        ...
        return self._repo_list_push_mirrors_oapg(
