...
# body param
SchemaForRequestBodyApplicationJson = CreatePushMirrorOption
...
SchemaFor201ResponseBodyApplicationJson = PushMirror
...
class BaseApi(api_client.Api):
    @typing.overload
    def _repo_add_push_mirror_oapg(
        self,
...
class RepoAddPushMirror(BaseApi):
    ...
    def repo_add_push_mirror(
        ...
        return self._repo_add_push_mirror_oapg(
            body=body,
