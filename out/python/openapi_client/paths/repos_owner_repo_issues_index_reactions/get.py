...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Reaction']:
            return Reaction

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['Reaction'], typing.List['Reaction']],
    ...
    def __getitem__(self, i: int) -> 'Reaction':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _issue_get_issue_reactions_oapg(
        self,
...
class IssueGetIssueReactions(BaseApi):
    ...
    def issue_get_issue_reactions(
        ...
        return self._issue_get_issue_reactions_oapg(
