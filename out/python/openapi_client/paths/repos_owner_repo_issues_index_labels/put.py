...
# body param
SchemaForRequestBodyApplicationJson = IssueLabelsOption
...
class BaseApi(api_client.Api):
    @typing.overload
    def _issue_replace_labels_oapg(
        self,
...
class IssueReplaceLabels(BaseApi):
    ...
    def issue_replace_labels(
        ...
        return self._issue_replace_labels_oapg(
            body=body,
