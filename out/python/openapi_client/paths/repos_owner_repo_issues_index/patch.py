...
# body param
SchemaForRequestBodyApplicationJson = EditIssueOption
...
SchemaFor201ResponseBodyApplicationJson = Issue
...
class IssueEditIssue(BaseApi):
    ...
    def issue_edit_issue(
        ...
        return self._issue_edit_issue_oapg(
            body=body,
