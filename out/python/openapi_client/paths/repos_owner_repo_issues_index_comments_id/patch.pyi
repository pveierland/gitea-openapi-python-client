...
# body param
SchemaForRequestBodyApplicationJson = EditIssueCommentOption
...
class BaseApi(api_client.Api):
    @typing.overload
    def _issue_edit_comment_deprecated_oapg(
        self,
...
class IssueEditCommentDeprecated(BaseApi):
    ...
    def issue_edit_comment_deprecated(
        ...
        return self._issue_edit_comment_deprecated_oapg(
            body=body,
