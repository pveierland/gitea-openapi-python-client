...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PackageFile']:
            return PackageFile

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['PackageFile'], typing.List['PackageFile']],
    ...
    def __getitem__(self, i: int) -> 'PackageFile':
...
class ListPackageFiles(BaseApi):
    ...
    def list_package_files(
        ...
        return self._list_package_files_oapg(
