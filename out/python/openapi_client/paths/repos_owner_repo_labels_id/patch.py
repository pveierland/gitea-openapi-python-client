...
# body param
SchemaForRequestBodyApplicationJson = EditLabelOption
...
SchemaFor200ResponseBodyApplicationJson = Label
...
class IssueEditLabel(BaseApi):
    ...
    def issue_edit_label(
        ...
        return self._issue_edit_label_oapg(
            body=body,
