...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TopicResponse']:
            return TopicResponse

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['TopicResponse'], typing.List['TopicResponse']],
    ...
    def __getitem__(self, i: int) -> 'TopicResponse':
...
class TopicSearch(BaseApi):
    ...
    def topic_search(
        ...
        return self._topic_search_oapg(
