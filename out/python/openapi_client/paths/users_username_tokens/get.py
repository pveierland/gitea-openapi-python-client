...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AccessToken']:
            return AccessToken

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['AccessToken'], typing.List['AccessToken']],
    ...
    def __getitem__(self, i: int) -> 'AccessToken':
...
class UserGetTokens(BaseApi):
    ...
    def user_get_tokens(
        ...
        return self._user_get_tokens_oapg(
