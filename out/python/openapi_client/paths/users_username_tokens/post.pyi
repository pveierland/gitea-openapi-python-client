...
# body param
SchemaForRequestBodyApplicationJson = CreateAccessTokenOption
...
SchemaFor201ResponseBodyApplicationJson = AccessToken
...
class UserCreateToken(BaseApi):
    ...
    def user_create_token(
        ...
        return self._user_create_token_oapg(
            body=body,
