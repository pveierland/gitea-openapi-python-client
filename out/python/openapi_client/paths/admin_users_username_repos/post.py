...
# body param
SchemaForRequestBodyApplicationJson = CreateRepoOption


request_body_repository = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _admin_create_repo_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_repository.serialize(body, content_type)
...
class AdminCreateRepo(BaseApi):
    ...
    def admin_create_repo(
        ...
        return self._admin_create_repo_oapg(
            body=body,
