...
SchemaFor201ResponseBodyApplicationJson = WikiPage
SchemaFor201ResponseBodyTextHtml = WikiPage
...
_response_for_201 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'text/html': api_client.MediaType(
            schema=SchemaFor201ResponseBodyTextHtml),
    },
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _repo_create_wiki_page_oapg(
        self,
...
class RepoCreateWikiPage(BaseApi):
    ...
    def repo_create_wiki_page(
        ...
        return self._repo_create_wiki_page_oapg(
            body=body,
