...
# body param
SchemaForRequestBodyApplicationJson = CreateFileOptions
...
SchemaFor201ResponseBodyApplicationJson = FileResponse
...
class RepoCreateFile(BaseApi):
    ...
    def repo_create_file(
        ...
        return self._repo_create_file_oapg(
            body=body,
