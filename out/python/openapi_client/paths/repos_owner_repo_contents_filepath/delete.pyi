...
request_path_filepath = api_client.PathParameter(
    name="filepath",
    style=api_client.ParameterStyle.SIMPLE,
...
# body param
SchemaForRequestBodyApplicationJson = DeleteFileOptions
...
SchemaFor200ResponseBodyApplicationJson = FileDeleteResponse
...
class RepoDeleteFile(BaseApi):
    ...
    def repo_delete_file(
        ...
        return self._repo_delete_file_oapg(
            body=body,
