...
# body param
SchemaForRequestBodyApplicationJson = CreateIssueCommentOption
...
class BaseApi(api_client.Api):
    @typing.overload
    def _issue_create_comment_oapg(
        self,
...
class IssueCreateComment(BaseApi):
    ...
    def issue_create_comment(
        ...
        return self._issue_create_comment_oapg(
            body=body,
