...
SchemaFor200ResponseBodyApplicationJson = PushMirror
...
class BaseApi(api_client.Api):
    @typing.overload
    def _repo_get_push_mirror_by_remote_name_oapg(
        self,
...
class RepoGetPushMirrorByRemoteName(BaseApi):
    ...
    def repo_get_push_mirror_by_remote_name(
        ...
        return self._repo_get_push_mirror_by_remote_name_oapg(
