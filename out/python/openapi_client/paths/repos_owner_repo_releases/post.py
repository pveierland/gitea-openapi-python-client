...
# body param
SchemaForRequestBodyApplicationJson = CreateReleaseOption
...
SchemaFor201ResponseBodyApplicationJson = Release
...
class RepoCreateRelease(BaseApi):
    ...
    def repo_create_release(
        ...
        return self._repo_create_release_oapg(
            body=body,
