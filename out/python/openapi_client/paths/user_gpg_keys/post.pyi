...
# body param
SchemaForRequestBodyApplicationJson = CreateGPGKeyOption


request_body_form = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = GPGKey
...
class BaseApi(api_client.Api):
    @typing.overload
    def _user_current_post_gpg_key_oapg(
        self,
    ...
    def _user_current_post_gpg_key_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_form.serialize(body, content_type)
...
class UserCurrentPostGpgKey(BaseApi):
    ...
    def user_current_post_gpg_key(
        ...
        return self._user_current_post_gpg_key_oapg(
            body=body,
