...
class SortSchema(
    ...
    @schemas.classproperty
    def LEASTINDEX(cls):
        return cls("leastindex")
    
    @schemas.classproperty
    def HIGHESTINDEX(cls):
        return cls("highestindex")
...
class RepoListStatuses(BaseApi):
    ...
    def repo_list_statuses(
        ...
        return self._repo_list_statuses_oapg(
