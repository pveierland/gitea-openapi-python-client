...
SchemaFor200ResponseBodyApplicationJson = CombinedStatus
...
class BaseApi(api_client.Api):
    @typing.overload
    def _repo_get_combined_status_by_ref_oapg(
        self,
...
class RepoGetCombinedStatusByRef(BaseApi):
    ...
    def repo_get_combined_status_by_ref(
        ...
        return self._repo_get_combined_status_by_ref_oapg(
